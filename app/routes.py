...
from app.resources.stock import StockYear, StockMonth, UpdateTillNow
...
api.add_resource(StockYear, '/stock-t-span/<string:name>/y/<int:year_ago>')
api.add_resource(StockMonth, '/stock-t-span/<string:name>/m/<int:month_ago>')
api.add_resource(UpdateTillNow, '/up-to-now')
